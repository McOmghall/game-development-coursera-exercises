...
public class CameraControl : MonoBehaviour {
    ...
    void FixedUpdate () {
        Camera.main.transform.position = Vector3.MoveTowards(Camera.main.transform.position, new Vector3(transform.position.x, transform.position.y + height, transform.position.z), movementSpeedMax);
        ...
        Quaternion rotationToTurn = Quaternion.Slerp(rotationToPlayer, rotationToMouse, (angleDiff < minimalMouseDifferenceToChangeCamera ? 0 : 0.5f));
